...
<body>
	<div style="width: 600px; text-align: left; margin: 0 auto;">
		...
		<div style="border: 1px solid #005da7; font-size: 16px; line-height: 50px; padding: 20px;">
			...
			<div>扫一扫，关注开心学院微信公共号，里面更多精彩推荐</div>
			<div>
				<img src="http://account.roncoo.com/images/qrcode.png" alt="开心学院公众号二维码" />
			</div>
			<div>
				想了解更多信息，请访问 <a href="http://www.noe.com">http://www.noe.com</a>
			</div>
		</div>
	</div>
</body>
